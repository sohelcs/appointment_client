...
const Banner = () => {
    return (
        <div className="h-screen">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-16 text-center h-full  my-auto flex flex-col items-center justify-center">
                <p className="mx-auto max-w-2xl text-lg tracking-tight text-slate-700">Welcome to
                    <span className="border-b border-dotted border-slate-300"> Slotify</span>
                </p>
                ...
                <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
                    ...
                    <span className="inline-block">Booking Solution</span>
                </h1>
                ...
                <div className="mt-12 flex flex-col justify-center gap-y-5 sm:mt-10 sm:flex-row sm:gap-y-0 sm:gap-x-6">
                    <a className="group inline-flex items-center justify-center rounded-full py-2 px-4 text-sm font-semibold focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 bg-slate-900 text-white hover:bg-slate-700 hover:text-slate-100 active:bg-slate-800 active:text-slate-300 focus-visible:outline-slate-900 animate-fade-in-left"
                        href="#">
                        <CiLocationArrow1 />
                        <span className="ml-3">Start Your Free Trial</span>
                    </a>
